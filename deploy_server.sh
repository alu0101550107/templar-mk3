...
echo ""
echo "Si vas a exponer este servidor directo a Internet (no solo VPN/LAN) y"
echo "tienes un dominio o subdominio propio (p.ej. DNS dinamico tipo"
echo "DuckDNS), corre despues ./setup_letsencrypt.sh para sustituir el"
echo "certificado autofirmado por uno real de Let's Encrypt."
