...
class UpdateChecker : public QObject {
 ...
 public:
  ...
  // GitHub redirige sola al release mas reciente). Deliberadamente NO es
  // un enlace de descarga directa del .apk: Android (Play Protect/Safe
  // Browsing) se queda colgado al 100% con una descarga directa iniciada
  // fuera de un navegador real, algo que no pasa si el usuario pincha
  // "Descargar" desde la propia pagina del release.
